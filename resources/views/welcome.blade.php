    ...
    <section class="px-6 py-8">
        <nav class="md:flex md:justify-between md:items-center">
            ...
            <div class="mt-8 md:mt-0">
                <a href="/addPost" class="text-xs font-bold uppercase">Post A Blog!</a>
            ...
            <div class="space-y-2 lg:space-y-0 lg:space-x-4 mt-8">
                ...
                <div class="relative flex lg:inline-flex items-center bg-gray-100 rounded-xl">
                    <form action="/hallo" method="GET">
                        <select class="flex-1 appearance-none bg-transparent py-2 pl-3 pr-9 text-sm font-semibold" style="outline: none;">
                            <option value="category" disabled selected>Category
                            </option>
                            <option value="Personal" name="Techniques">Techniques</option>
                ...
                <div class="relative flex lg:inline-flex items-center bg-gray-100 rounded-xl px-3 py-2">
                    <form method="GET" action="#">
                        <input type="text" name="search" placeholder="Find something" style="outline: none;" class="bg-transparent placeholder-black font-semibold text-sm">
                    </form>
                </div>
                <!-- End Of Search -->
            </div>
                    ...
                    <div class="py-6 px-5">
                        <article>
                            ...
                            <footer class="flex justify-between items-center mt-8">
                                ...
                                <div>
                                    <a href="post/<?= $post->id; ?>" class="transition-colors duration-300 text-xs font-semibold bg-gray-200 hover:bg-gray-300 rounded-full py-2 px-8">
                                        Read More
                                    </a>
                                </div>
                            </footer>
